...
export default function Button({
  ...
  const base =
    "px-4 py-3 sm:cursor-pointer text-sm disabled:opacity-40 disabled:cursor-not-allowed";
  const color =
    variant === "primary"
      ? "bg-primary text-white dark:bg-white dark:text-black hover:opacity-80"
